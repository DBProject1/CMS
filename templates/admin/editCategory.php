...
<?php include "templates/admin/include/header.php" ?>
      ...
      <form action="login.php?action=<?php echo $results['formAction']?>" method="post">
...
<?php if ( $results['category']->id ) { ?>
      <p><a href="login.php?action=deleteCategory&amp;categoryId=<?php echo $results['category']->id ?>" onclick="return confirm('Delete This Category?')">Delete This Category</a></p>
<?php } ?>
